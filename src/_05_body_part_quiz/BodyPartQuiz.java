...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess.equalsIgnoreCase("Arnold Schwarzenegger")) {
			score++;
			JOptionPane.showMessageDialog(null, "UR CORRECT");
		}
		// 6. Otherwise:
		// -- Tell them they are wrong and who the person is
		else {
			JOptionPane.showMessageDialog(null, "You are wrong...That is arnold schwarzenegger");
		}
		...
		if (guess.equalsIgnoreCase("Leonardo DiCaprio")) {
			...
			JOptionPane.showMessageDialog(null, "You are incorrect...That is Leonardo DiCaprio");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("Who is this?");
		if (guess.equalsIgnoreCase("Morgan Freeman")) {
			...
			JOptionPane.showMessageDialog(null, "You are incorrect...That is Morgan Freemab");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("Final question...WHO IS THIS?!?!?");
		if (guess.equalsIgnoreCase("Jack Black")) {
			score++;
			JOptionPane.showMessageDialog(null, "UR CORRECT");
		} else {
			JOptionPane.showMessageDialog(null,
					"You are bad..that is Jack Black                  uranunculturaledswine");
		}
